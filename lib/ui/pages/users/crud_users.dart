...
class _CrudUsersState extends State<CrudUsers> {
  ...
  Map<String, String> generateUsernameAndPassword(String name, String lastname, String surname, int ci) {
    ...
    final password = name.substring(0, 2).toLowerCase() + ci.toString().substring(0, 2);
                                            ...
                                            onTap: () async {
                                              if (formKey.currentState!.validate()) {
                                                try {
                                                  ...
                                                  final credentials = generateUsernameAndPassword(
                                                  ...
                                                  print('Generated Username: ${credentials['username']}');
                                                  print('Generated Password: ${credentials['password']}');
